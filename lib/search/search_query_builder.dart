...
class SearchQueryBuilder {
  ...
  /// - `"` בין אותיות נשמר כחלק מהטוקן (כך `רמב"ם` נשאר טוקן יחיד).
  /// - `'` בין אותיות נשמר כחלק מהטוקן (תעתיקים: `ג'ורג'`, `ד'אש`).
  /// - `"` בקצוות (לפני/אחרי לא-מילה) מפריד.
  ...
  static final RegExp _tokenExtractor = RegExp(
    r"""[א-ת֐-ׇA-Za-z0-9]+(?:["'][א-ת֐-ׇA-Za-z0-9]+)*(?:'(?![א-ת֐-ׇA-Za-z0-9]))?""",
  );
