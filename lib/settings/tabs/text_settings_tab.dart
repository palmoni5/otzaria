...
class TextSettingsTab extends StatelessWidget {
  ...
  Widget _buildNikudSection(BuildContext context, SettingsState state) {
    ...
    return SettingsCard(
      ...
      children: [
        ...
        SwitchSettingsTile(
          ...
          title: RichText(
            text: TextSpan(
              ...
              children: [
                TextSpan(text: 'settings.text.holy_names_title'.tr()),
              ],
            ),
          ),
          subtitle: Text(
        ...
        SwitchSettingsTile(
          title: Text('settings.text.teamim_title'.tr(),
            ...
            builder: (context, constraints) {
              ...
              final formatEntries = [
                ...
                AppMenuEntry(
                  ...
                  label:
                      'settings.text.format_same_line_after_no_brackets'.tr(),
                ),
                AppMenuEntry(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('settings.text.format_title'.tr(),
                                    style: kSettingsTitleStyle),
                                Text(formatSubtitle,
                                    style: kSettingsSubtitleStyle),
                              ],
              ...
              return ListTile(
                ...
                title: Text('settings.text.format_title'.tr(),
                    style: kSettingsTitleStyle),
  ...
  Widget _buildPerBookSection(BuildContext context, SettingsState state) {
    return SettingsCard(
      ...
      children: [
        SwitchSettingsTile(
          title: Text('settings.text.per_book_title'.tr(),
              style: kSettingsTitleStyle),
          subtitle: Text(
